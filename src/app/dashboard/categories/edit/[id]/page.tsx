...
export default function EditOutletPage() {
  ...
  const outlet = useMemo(() => mockOutletData[outletId] || { name: 'Unknown Outlet' }, [outletId]);
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 bg-muted/30 min-h-[calc(100vh-4rem)]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h1 className="text-3xl font-bold tracking-tight text-foreground">Edit Outlet</h1>
                <p className="text-muted-foreground mt-1">Update details for {outlet.name}</p>
              </div>
            </div>
                    ...
                    <div className="flex-1 space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input defaultValue={outlet.name} className="bg-background h-11" />
                        </div>
                        <div className="space-y-2">
                          <Label className="text-sm font-semibold">Outlet slug <span className="text-red-500">*</span></Label>
                          <div className="relative">
                            <Input defaultValue={outlet.name.toLowerCase().replace(/\s+/g, '-')} className="bg-background h-11 pr-10" />
                ...
                <section className="space-y-6 pt-8 border-t">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input defaultValue={outlet.address} className="bg-background h-11" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-sm font-semibold">City <span className="text-red-500">*</span></Label>
                      <Input defaultValue={outlet.location} className="bg-background h-11" />
                    </div>
                  </div>
          ...
          <div className="mt-8 flex justify-end gap-3 text-right pb-12">
            ...
            <Button className="px-10 h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-bold gap-2 rounded-xl shadow-xl shadow-primary/20" onClick={handleSave}>
              <Save className="h-4 w-4" />
              Save Changes
            </Button>
          </div>
